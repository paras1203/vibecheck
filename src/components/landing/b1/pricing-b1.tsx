    ...
    <section id="pricing" className="border-t border-[var(--lv-minimal-border)] bg-[var(--lv-minimal-bg)] px-4 py-24 md:px-8">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-8 grid min-h-[480px] gap-6 md:grid-cols-3 md:gap-8">
          <Card className="flex h-full flex-col rounded-3xl border-0 bg-[var(--lv-minimal-surface-1)] shadow-surface-sm">
            <CardHeader>
            ...
            <CardContent className="flex flex-1 flex-col space-y-4 py-6">
              <div className="mb-2 font-mono text-4xl font-semibold tabular-nums text-[var(--lv-minimal-text)]">
              ...
              <div className="mt-auto flex flex-col gap-2">
                <Button
                  ...
                  disabled={loading}
                  variant="outline"
                  className="w-full rounded-2xl border-[var(--lv-minimal-border)]"
                >
                  Get Free Audit
                </Button>
                <Button asChild variant="outline" className="w-full rounded-2xl border-[var(--lv-minimal-border)]">
          ...
          <Card className="relative flex h-full flex-col overflow-hidden rounded-3xl border-0 bg-[var(--lv-minimal-bg)] shadow-surface-sm ring-2 ring-[var(--lv-minimal-accent)]/25">
            <div className="absolute right-4 top-4">
              <Badge className="rounded-full bg-[var(--lv-minimal-accent)] text-white hover:bg-[var(--lv-minimal-accent)]">
                Single roast
              </Badge>
            </div>
            <CardHeader>
            ...
            <CardContent className="flex flex-1 flex-col space-y-6 py-6">
              ...
              <div className="h-8 text-sm font-semibold text-[var(--lv-minimal-accent)]">
              ...
              {loading ? (
                <Button disabled className="mt-auto w-full rounded-2xl">
                  Get Your Roast
                </Button>
              ) : (
                <Button asChild className="mt-auto w-full rounded-2xl">
          ...
          <Card className="flex h-full flex-col rounded-3xl border-0 bg-[var(--lv-minimal-surface-1)] shadow-surface-sm">
            ...
            <CardContent className="flex flex-1 flex-col space-y-6 py-6">
              ...
              <div className="space-y-1 text-sm font-semibold text-[var(--lv-minimal-accent)]">
